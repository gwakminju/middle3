...
class SixteenViewController : UIViewController, UIPickerViewDelegate, UIPickerViewDataSource,UITextFieldDelegate{
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let DestViewController : TodoList16ViewController = segue.destination as! TodoList16ViewController
