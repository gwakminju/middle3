...
class NineteenViewController : UIViewController, UIPickerViewDelegate, UIPickerViewDataSource,UITextFieldDelegate{
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let DestViewController : TodoList19ViewController = segue.destination as! TodoList19ViewController
