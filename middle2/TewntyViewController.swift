...
class TewntyViewController : UIViewController, UIPickerViewDelegate, UIPickerViewDataSource,UITextFieldDelegate{
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let DestViewController : TodoList20ViewController = segue.destination as! TodoList20ViewController
