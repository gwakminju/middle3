...
class SeventeenViewController : UIViewController, UIPickerViewDelegate, UIPickerViewDataSource,UITextFieldDelegate{
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let DestViewController : TodoList17ViewController = segue.destination as! TodoList17ViewController
